      ...
      slides: [
        {
          ...
          description:
            '<b>DISKON PAKET UP TO 50% (ALL PAKET)</b><br/>Berlaku untuk semua paket service di TJM AC Mobil. Dapatkan potongan harga hingga setengahnya untuk perawatan AC mobil Anda.',
        },
        {
          image: '/image/promo/ac2.webp',
          description:
            '<b>GRATIS CARWASH + CLAYBAR + VACUUM INTERIOR (SELAIN PROMO PAKET 97 RIBU)</b><br/>Setiap servis AC (di luar paket 97 ribu), mobil Anda akan kami cuci bersih, treatment clay bar untuk menghilangkan noda membandel, dan vacuum interior.',
        },
        {
        ...
        },
        {
          ...
          description:
            '<b>GRATIS SHAKING MACHINE (ALL PAKET)</b><br/>Pengecekan kaki-kaki menggunakan shaking machine untuk mendeteksi masalah dengan lebih akurat. Gratis untuk semua paket servis AC.',
        },
        {
          image: '/image/promo/ac10.webp',
          description:
            '<b>GRATIS SPOORING (ALL PAKET)</b><br/>Luruskan kembali posisi roda mobil Anda dengan spooring gratis dari kami. Berlaku untuk semua paket servis AC.',
        },
        {
        ...
        },
        {
          ...
          description:
            '<b>PROMO SERVICE AC 97 RIBU</b><br/>Paket servis AC super hemat hanya 97 ribu! Sudah termasuk pengecekan dasar dan penambahan freon jika diperlukan.',
        },
      ],
    },
  },
    ...
    details: {
      slides: [
        ...
        },
        {
          ...
          description:
            'Gratis Inspeksi AC Mobil 20 Titik untuk memastikan sistem AC mobil Anda bekerja optimal! Tim teknisi kami akan memeriksa secara menyeluruh 20 komponen penting, mulai dari tekanan freon, filter kabin, hingga kondisi kompresor dan kipas pendingin Dan Komponen Penting yang lainnya. Cegah kerusakan lebih lanjut dan nikmati udara sejuk selama berkendara, tanpa biaya!',
        },
        {
        ...
        },
        {
          ...
          description:
            'Ozone Treatment adalah layanan sterilisasi kabin mobil menggunakan gas ozon untuk membunuh bakteri, virus, jamur, dan menghilangkan bau tidak sedap. Proses ini menjangkau seluruh area kabin, termasuk ventilasi AC, sehingga udara di dalam mobil menjadi lebih bersih dan segar. Cocok untuk Anda yang mengutamakan kesehatan dan kenyamanan selama berkendara!',
        },
        {
          image: '/image/promo/detailing10.webp',
          description:
            'Hanya dengan memasang stiker di mobil Anda maka Anda akan mendapatkan promo seumur hidup.<br/><br/><b>Benefit dari Stiker Mobil TJM:</b><br/>- Priority Booking<br/>- Free Inspeksi all in sepuasnya setiap hari<br/>- Diskon 5% paket service apapun di TJM Auto Care (transaksi selanjutnya)<br/>- Diskon 50% paket nano ceramic coating di TJM Auto Detailing<br/>- Diskon 50% paket detailing di TJM Auto Detailing<br/>- Diskon 30% paket anti karat di TJM Auto Rust Protection<br/>- Tebus Murah Paket AC All In Rp. 250.000<br/>- Tebus Murah Poles Jamur Kaca senilai Rp. 100.000<br/>- Free Voucher Konsultasi Bisnis dan Hukum di Sentinel Law Firm sepuasnya<br/>- FREE Voucher Konsultasi Penagihan utang di Sentinel VIP sepuasnya<br/>- Free Fogging Kabin Mobil 3x senilai : 300.000<br/>- Bonus Wax Fusion After Service senilai : 300.000<br/><br/><b>Untuk program ini stiker wajib untuk ditempelkan ke mobil customer, jika tidak ada stiker maka promo tidak bisa di-klaim.</b>',
        },
        {
    ...
    details: {
      slides: [
        ...
        },
        {
          ...
          description:
            'Promo berlaku untuk seluruh paket di TJM Auto Care, proses pencucian mobil dengan sabun snow, dekontaminasi noda aspal pada mobil dengan clay bar, pembersihan debu dan kotoran pada kabin mobil dengan vacuum interior cleaner.',
        },
        {
        ...
        { image: '/image/promo/express11.webp' },
        {
          ...
          description:
            '<b>Ozone Treatment</b> adalah layanan sterilisasi kabin mobil menggunakan gas ozon untuk membunuh bakteri, virus, jamur, dan menghilangkan bau tidak sedap. Proses ini menjangkau seluruh area kabin, termasuk ventilasi AC, sehingga udara di dalam mobil menjadi lebih bersih dan segar. Cocok untuk Anda yang mengutamakan kesehatan dan kenyamanan selama berkendara!',
        },
        {
    ...
    details: {
      slides: [
        ...
        },
        {
          ...
          description:
            '<b>Rat & Bugs Repellent Engine</b> adalah layanan perlindungan ruang mesin mobil dari serangan tikus dan serangga. Menggunakan formula khusus yang aman bagi komponen kendaraan namun efektif mengusir hama, layanan ini membantu mencegah kerusakan kabel, selang, dan bagian penting lainnya. Solusi praktis untuk menjaga performa mesin tetap optimal dan bebas gangguan!',
        },
        {
        ...
        },
        {
          ...
          description:
            'Diskon paket Kaki-Kaki <b>UP TO 70%</b> berlaku untuk seluruh paket Kaki-Kaki dan bisa di-claim di seluruh outlet TJM manapun.',
        },
        {
          image: '/image/promo/autocare21.webp',
          description:
            'Khusus <b>transaksi di atas 2 Juta</b>, customer akan mendapatkan harga khusus service AC dan berlaku untuk outlet tertentu saja, hanya outlet Bekasi dan Balikpapan.',
        },
      ],
    },
  },
